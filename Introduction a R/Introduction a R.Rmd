...
La fonction `str()` indique la structure des données.
```{r}
str(mtcars)
```
Indique que nous avons un `data.frame` de 32 observations et 11 colonnes, toutes les variables sont de type numériques (`num`) et aperçu des premières observations de chaque variable.
