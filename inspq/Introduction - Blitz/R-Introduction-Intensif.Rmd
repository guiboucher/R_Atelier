...
```
<br><br>
Exemples : année, age, code d'identification numérique.
...
Puisqu'un vecteur contient un même type de données, il convertira les nombre en caractères au besoin
...
- Il est important de savoir ce qu'est un `vector` et un `data.frame`.
- Il est impossible de tout connaître en R.
- Une recherche Google ou une question à Copilot peut rapidement répondre à votre question plutôt que de connaître les milliers de fonctions et objets dans le *package* R de base.
