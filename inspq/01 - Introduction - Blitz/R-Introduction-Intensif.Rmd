...
`head()` et `tail()` pour voir les premières ou les dernières lignes d'une table.
```{r}
...
En date du 8 septembre 2026, il y a 24 894 *packages* de disponibles sur le [CRAN](https://cran.r-project.org/web/packages/).
